...
public class HomePage {
	...
	HomePage(int userId, String username) {
		System.out.println("--------------------------------------------------------");
	...
	private void displayPerson(Person person) {
		System.out.print(person.getName() + "\t\t" + person.getAge() + "\t\t" + person.getHomeLocation() + "\t\t"
				+ person.getJobType() + "\t\t" + person.getSalary() + "\t\t" + person.getEducation());
		System.out.println();
	}
